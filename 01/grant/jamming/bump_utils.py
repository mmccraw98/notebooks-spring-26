...
def create_clumps(phi, N, mu_eff, aspect_ratio, min_nv, mass, max_neighbors = None):
    dim = 2
...
def create_clumps_3d(phi, N, asperity_radius, aspect_ratio, min_nv, mass, max_neighbors = None):
    dim = 3
