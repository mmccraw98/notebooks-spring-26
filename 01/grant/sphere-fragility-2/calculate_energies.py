...
if __name__ == "__main__":
    ...
    # get the energies
    pe = jax.vmap(jax.vmap(jd.utils.compute_potential_energy))(state_traj, system_traj)
    ke = jax.vmap(jax.vmap(jd.utils.compute_translational_kinetic_energy))(state_traj)
    np.savez(f'{which}-energies.npz', pe=pe, ke=ke, temp=cfg.target_temperatures)